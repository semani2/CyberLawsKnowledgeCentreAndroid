...
public class IprLawCourse extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ipr_law_course);
        ...
        addTabs(actionBar);
        viewPager.setAdapter(new IprClassMyAdapter(getSupportFragmentManager()));
...
class IprClassMyAdapter extends FragmentStatePagerAdapter
{

    public IprClassMyAdapter(android.support.v4.app.FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int i) {
        ...
        if(i==0)
        {
            fragment=new IprLawCourseInfo();
        }
        if(i==1)
        {
            fragment=new IprLawCourseApplicability();
        }
        if(i==2)
        {
            fragment=new IprLawCourseSyllabus();
        }
