...
public class CyberLawCourse extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cyber_law_course);
...
class MyAdapter extends FragmentStatePagerAdapter
{
    ...
    public Fragment getItem(int i) {
        ...
        if(i==0)
        {
            fragment=new CyberLawCourseInfo();
        }
        if(i==1)
        {
            fragment=new CyberLawCourseApplicability();
        }
        if(i==2)
        {
            fragment=new CyberLawCourseSyllabus();
        }
