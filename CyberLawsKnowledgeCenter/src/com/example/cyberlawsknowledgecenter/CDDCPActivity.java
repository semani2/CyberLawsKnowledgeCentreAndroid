...
public class CDDCPActivity extends FragmentActivity implements ActionBar.TabListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTabs(actionBar);
        viewPager.setAdapter(new CDDCPMyAdapter(getSupportFragmentManager()));
...
class CDDCPMyAdapter extends FragmentStatePagerAdapter
{

    public CDDCPMyAdapter(android.support.v4.app.FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int i) {
        ...
        if(i==0)
        {
            fragment=new CDDCPCourseInfo();
        }
        if(i==1)
        {
            fragment=new CDDCPCourseApplicability();
        }
        if(i==2)
        {
            fragment=new CDDCPCourseSyllabus();
        }
